        ...
        <div class="modal-content ps-4 py-0" style="border-radius: 18px !important;">
            <div class="modal-body py-0">
                <form action="{{ route('survey.store') }}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-5 text-start border-end pt-5 pe-0" id="create-assessment-sidebar-col">
                            <ul class="list-unstyled font-weight-bold my-5" id="create-assessment-sidebar">
                        ...
                        <div class="col-7 text-center my-4 d-inline" id="first-step">
                            ...
                            <div class="row justify-content-center my-5">
                                <div class="col-10">
                                    ...
                                    <div class="mb-3">
                                        <textarea id="assessment-description" type="text" class="survey-description form-control input-text"
                                            style="resize: none; height:7rem;"
                                            name="description" required placeholder="Deskripsi Survei"></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <input id="assessment-category" type="hidden" name="survey_category">
                                    ...
                                    <div class="mb-3">
                                        <input id="assessment-type" type="hidden" name="survey_type">
                        ...
                        <div class="col-7 text-center my-4 d-none" id="second-step-private">
                            ...
                            <div class="row justify-content-center my-5 text-start">
                                ...
                                <div class="col-10">
                                    <div class="row justify-content-between align-items-center px-2 mb-2">
                                        <span class="col-4 text-gawedata text-start cursor-pointer ps-0"
                                            id="create-assessment-back-button-2-private">
                                            <span class="fa fa-fw fa-arrow-left me-2"></span>Sebelumnya
                                        </span>
                                        <button type="submit" class="btn btn-gawedata col-4 py-2"
                                            id="create-assessment-next-button-2-private" onclick="event.preventDefault()">
                                            Selanjutnya
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="col-7 text-center my-4 d-none" id="third-step">
                            ...
                            <div class="row justify-content-center my-5 text-start">
                                <div class="col-10">
                                    ...
                                    <div class="row justify-content-between align-items-center mb-3">
                                        ...
                                        <div class="col-7 text-end">
                                            <div
                                                ...
                                                <input type="text" name="survey_deadline" id="assessment-deadline"
                                    ...
                                    <div class="row justify-content-between align-items-center mb-3">
                                        <div class="col-12">
                                            <input type="number" name="survey_respondent" id="assessment-respondent"
                                ...
                                <div class="col-10">
                                    <div class="row justify-content-between align-items-center px-2 mb-2">
                                        <span class="col-4 text-gawedata text-start cursor-pointer ps-0"
                                            id="create-assessment-back-button-3">
                                            <span class="fa fa-fw fa-arrow-left me-2"></span>Sebelumnya
                                        </span>
                                        <button type="submit" class="btn btn-gawedata col-4 py-2" disabled
                                            id="create-assessment-next-button-3">
                                            Selanjutnya
                                        </button>
                                    </div>
                                </div>
